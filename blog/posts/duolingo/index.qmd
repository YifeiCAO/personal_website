...
In essence, Duolingo claims to be a mission-driven learning company wanting to enable learning for all, but it feels as though this noble goal is being slightly corrupted by good ol' corporate greed. In some sense, Duolingo is increasinlgy following the usual Tech company recipe of "first capture the market, then aggressively monetize". The company has been shifting away from user-centric design, which feels ironic because its more user-centric past approach is arguably what made it so successful in the first place. I'll give you a few examples to paint the picture. 
